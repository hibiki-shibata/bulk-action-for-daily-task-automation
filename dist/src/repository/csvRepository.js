...
export async function csvRepository() {
    ...
    csvDataRows.forEach((rowOfCsv) => {
        ...
        if (!validRow) {
            ...
            listOfVenueIdsToUpdate.push(validRow);
        countLinesOfCsvRows += 1;
    });
    if (listOfVenueIdsToUpdate.length === 0)
        throw Error("The CSV file is empty or does not contain valid venue IDs.");
...
function csvDataFormatValidator(rowOfCsv) {
    ...
    if (isEmptyRow || hasMultipleColumns) {
        ...
        return trimedRowOfCsvData;
}
//# sourceMappingURL=csvRepository.js.map